...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('madera_site_article', 'show_date', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True))

    def backwards(self, orm):

        # Deleting field 'Article.show_date'
        db.delete_column('madera_site_article', 'show_date')

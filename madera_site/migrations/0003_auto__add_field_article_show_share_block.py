...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('madera_site_article', 'show_share_block', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'Article.show_share_block'
        db.delete_column('madera_site_article', 'show_share_block')

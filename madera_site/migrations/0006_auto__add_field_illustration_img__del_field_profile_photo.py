...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('madera_site_illustration', 'img', self.gf('yafotki.fields.YFField')(default=None, max_length=255, null=True, blank=True), keep_default=False)

        # Deleting field 'Profile.photo'
        db.delete_column('madera_site_profile', 'photo')

    def backwards(self, orm):

        # Deleting field 'Illustration.img'
        db.delete_column('madera_site_illustration', 'img')

        # Adding field 'Profile.photo'
        db.add_column('madera_site_profile', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

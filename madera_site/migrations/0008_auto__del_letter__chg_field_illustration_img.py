...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Illustration.img'
        db.alter_column('madera_site_illustration', 'img', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Illustration.img'
        db.alter_column('madera_site_illustration', 'img', self.gf('yafotki.fields.YFField')(max_length=255, null=True))
